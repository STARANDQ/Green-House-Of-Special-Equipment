...
<h1 class="adminControlTitle">Admin Panel</h1>
<div class="controlTable">
    <div class="blockLeft__controlTable">
        ...
        <div class="blockRight__controlTable">
            <a class="sendData" onclick="searchElem()">Search</a>
            <br><br>
            <a class="sendData" onclick="window.location.href='addPage.php'">Add</a>
        </div>
    </div>
...
if($counter === 0) echo "<h2 class='notFound'>No results found</h2>";
