...
<footer>
    <div class="footer__first">
        ...
        <div class="footer__first__admin-panel">
            <a class="footer__first__admin-panel__text" href="indexAdmin.php">Admin panel</a>
        </div>
    </div>
    <div class="footer__second-menu">
        <p class="footer__second-menu__text">Navigation</p>
        <div class="footer__second-menu__elems">
            <a class="footer__second-menu__elems__elem" href="index.php">Home</a>
            <a class="footer__second-menu__elems__elem" href="card.php">Basket</a>
            <a class="footer__second-menu__elems__elem" href="about.php">About us</a>
            <a class="footer__second-menu__elems__elem" href="contact.php">Contacts</a>
        </div>
    </div>
    <div class="footer__third">
        <div class="footer__third__options">
            <div class="footer__third__options__option">
                <p class="footer__third__options__option__text">Language</p>
            ...
            <div class="footer__third__options__option">
                <p class="footer__third__options__option__text">Design</p>
                <div class="footer__third__options__option__images">
        ...
        <div class="footer__third__social-networks">
            <span class="footer__third__social-networks__text">We are in social networks</span>
