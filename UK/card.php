...
<script>
    ...
    <div class="content_card">
        <h1 class="content_card__title">Корзина</h1>
    <?php
    ...
    <div class="footerCard">
        <div style="margin-right: 10px; display: inline-block; float: left;"><a class="sendData" onclick="setOrder()">Замовити</a></div>
        <div style="margin-left: 10px; display: inline-block; float: right;">
            <label for="generalPrice">Загальна ціна: </label>
