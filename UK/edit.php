...
if($id != "") {
    ...
    while ($elem = $result->fetch_assoc()) {
        ...
        <table>
            ...
            <tr>
                <td><label for="image">Зображення:</label></td>
            ...
            <tr>
                <td><label for="transportWeight">Вага транспорту: </label></td>
            ...
            <tr>
                <td><label for="maximumWeight">Вантажопідйомність: </label></td>
...
?>
    ...
    <form>
        ...
        <br><br><br>
        <a class="sendData" onclick="addRow();">Додати поле</a>
    ...
    <br>
<div>
    <div style="margin-left: 10px; display: inline-block; float: left;"><a class="sendData" style="background: #ff6060;" onclick="deleteObj()">Видалити</a></div>
    <div style="margin-right: 10px; display: inline-block; float: right;"><a class="sendData" onclick="sendData()">Готово</a></div>
</div>
    ...
    function addRow(){
        ...
        if(table.innerHTML === "") {
            table.innerHTML +=
                ...
                <tr data-id="id_' + 0 + '"> \
                    <td colspan="2" class="deleteBlock"><a onclick="deleteELem(' + 0 + ')">видалити</a><hr></td> \
                </tr>\n';
        }else
        {
            ...
            for(let i = 0; i < titles.length; i++){
                table.innerHTML +=
                    ...
                    <tr data-id="id_' + i + '"> \
                    <td colspan="2" class="deleteBlock"><a onclick="deleteELem(' + i + ')">видалити</a><hr></td> \
                    </tr>\n';
            }
            table.innerHTML +=
                ...
                <tr data-id="id_' + titles.length + '"> \
                    <td colspan="2" class="deleteBlock"><a onclick="deleteELem(' + titles.length + ')">видалити</a><hr></td> \
                </tr>\n';
        }
    }
